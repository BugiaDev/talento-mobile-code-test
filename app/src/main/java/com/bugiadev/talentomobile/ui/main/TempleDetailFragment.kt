...
import com.bugiadev.talentomobile.databinding.FragmentTempleDetailBinding
import com.bugiadev.talentomobile.ui.fragment.BaseFragment

class TempleDetailFragment : BaseFragment<FragmentTempleDetailBinding>() {
    private val args: TempleDetailFragmentArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        binding = FragmentTempleDetailBinding.inflate(inflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.confessionTextView.text = getString(R.string.non_catholic_confession)
