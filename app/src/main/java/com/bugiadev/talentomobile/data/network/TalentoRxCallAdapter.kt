package com.bugiadev.talentomobile.data.network
...
class TalentoRxCallAdapterFactory(
    private val rxCallAdapterFactory: RxJava2CallAdapterFactory
) : CallAdapter.Factory() {

    companion object {
        fun create(): TalentoRxCallAdapterFactory {
            return TalentoRxCallAdapterFactory(RxJava2CallAdapterFactory.create())
        }
    }
    ...
    override fun get(
        ...
        return TalentoRxCallAdapter(annotations, retrofit, rxJava2CallAdapter)
    }
}

private class TalentoRxCallAdapter constructor(
    ...
    private fun handleError(
        ...
        return if (errorType != null && throwable is HttpException) {
            ...
            TalentoHttpException(error, throwable.message(), throwable)
        } else {
            throwable
        }
    }
